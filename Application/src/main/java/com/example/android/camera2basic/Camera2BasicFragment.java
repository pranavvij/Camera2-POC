...
public class Camera2BasicFragment extends Fragment
     ...
     */
    long startTimestampForNthFrame = 0l;
    long startTimestampForNPlusOnethFrame = 0l;
    int nFrame = 0;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            if (startTimestampForNPlusOnethFrame == 0l || startTimestampForNPlusOnethFrame < System.currentTimeMillis()) {
                startTimestampForNthFrame = System.currentTimeMillis();
                startTimestampForNPlusOnethFrame = startTimestampForNthFrame + 1000;
                Log.d("onImageAvailable", "" + nFrame);
                nFrame = 0;
            }
            nFrame += 1;
            Image test = null;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                smallest = Collections.min(Arrays.asList(map.getOutputSizes(ImageFormat.JPEG)), new CompareSizesByArea());

                mImageReader = ImageReader.newInstance(smallest.getWidth(), smallest.getHeight(), ImageFormat.JPEG, /*maxImages*/2);
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_MODE, CaptureRequest.CONTROL_CAPTURE_INTENT_MOTION_TRACKING);
